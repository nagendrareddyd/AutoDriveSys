...
var instructor_list_component_1 = require("../instructor/instructor-list.component");
    ...
    core_1.NgModule({
        imports: [
            router_1.RouterModule.forChild([
                { path: 'instructors', component: instructor_list_component_1.InstructorListComponent }
            ])
        ],
        declarations: [
